...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 15-10-2024 a las 20:19:46
...
(1, '123', 'Angela Enciso', '988252459', '1', 'emp01'),
(2, '123', 'Roman Riquelme', '988252459', '1', 'Jo46'),
(3, '123', 'Palermo Suarez', '453536458', '0', 'Em22');
...
(1, 'Teclado Logitech 345 Editado', 150, 95, '0'),
(2, 'Mouse Logitech 567', 20, 92, '0'),
(3, 'Laptop Lenovo Ideapad 520', 800, 100, '0'),
(4, 'HeadPhones Sony M333', 500, 98, '0'),
(7, 'Producto Nuevo w', 22, 35, '0'),
(9, 'Teclado Halion', 25.5, 100, '0'),
(10, 'pizza', 12.5, 198, '0'),
(11, 'botella', 20, 12, '1'),
(12, 'IGV', 3.6, 1, '1'),
(13, 'Teclado Halion', 25.5, 100, '0'),
(14, 'PIZZA', 25.5, 100, '1');
...
(94, 18, 2, '000000001', '2023-04-22', 300, '1'),
(95, 17, 2, '000000002', '2023-05-29', 150, '1'),
(96, 17, 2, '000000002', '2023-05-29', 150, '1'),
(97, 17, 2, '000000003', '2023-06-02', 150, '1'),
(98, 17, 2, '000000004', '2023-07-18', 25, '1'),
(99, 18, 2, '000000005', '2023-08-23', 20, '1'),
(100, 17, 2, '000000006', '2024-01-02', 20, '1'),
(101, 18, 2, '000000007', '2024-01-02', 20, '1'),
(103, 17, 2, '000000008', '2024-05-21', 20, '1'),
(104, 18, 2, '000000009', '2024-07-04', 40, '1'),
(105, 17, 2, '000000010', '2024-07-29', 0, '1'),
(106, 17, 2, '000000010', '2024-07-29', 40, '1');
...
--
ALTER TABLE `ventas`
  MODIFY `IdVentas` int(11) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=108;
